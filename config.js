...
const envSchema = Joi.object({
  ...
  NSFW_MAX_VIDEO_MB: Joi.number().integer().min(1).max(100).default(25),
  NSFW_MAX_FRAMES: Joi.number().integer().min(1).max(60).default(12),
  NSFW_FRAME_INTERVAL_SEC: Joi.number().integer().min(1).max(30).default(2),
