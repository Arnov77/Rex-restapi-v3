...
const lqRoutes = async (app) => {
    ...
    app.get('/', {
        ...
        schema: {
            tags: ['maker'],
            summary: 'Degrade an image into blurry low quality meme aesthetic. Params: image, level, format, quality',
            querystring: LqQuery,
        },
    }, async (req, reply) => {
...
//# sourceMappingURL=lq.routes.js.map