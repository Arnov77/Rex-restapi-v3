 ...
 */
function getLqParams(level, userQuality) {
     ...
     */
    const finalQuality = clamp(Math.min(userQuality, internalQuality), 8, 95);
    /**
...
async function renderOnce(opts, signal) {
    ...
    const { scale, softBlur, saturation, brightness, finalQuality, recompressQuality, } = getLqParams(opts.level, opts.quality);
...
//# sourceMappingURL=lq.service.js.map